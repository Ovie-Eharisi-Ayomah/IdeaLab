/**
 * Anthropic Claude-based business idea classifier with few-shot and chain-of-thought prompting
 */
...
/**
 * Classifies a business idea using Anthropic Claude with few-shot and chain-of-thought prompting
 * 
 ...
 */
async function classifyWithAnthropic(businessDescription, options = {}) {
...
Product Type: [Final product type classification]`;
    ...
    throw new Error(`Anthropic classification failed: ${error.message}`);
  }
}
